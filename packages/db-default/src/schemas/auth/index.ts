...
export {
	accounts,
	relations as accountsRelations,
} from './authentication/accounts';
export {
	providers,
	relations as providersRelations,
} from './authentication/providers';
export {
	sessions,
	relations as sessionsRelations,
...
export {
	permissions,
	relations as permissionsRelations,
} from './permissions/permissions';
export {
	resources,
	relations as resourcesRelations,
} from './permissions/resources';

// Roles
export {
	rolePermissions,
	relations as rolePermissionsRelations,
